...
myClock = pygame.image.load('/Users/alikhan/PycharmProjects/PP2_Alikhan/Labs/lab_7/assets/mainclock.png')
myClock = pygame.transform.scale(myClock, (600, 600))

minute_arrow = pygame.image.load('/Users/55555/PP2/Lab_7/assets/rightarm.png')  # 30:257
minute_arrow = pygame.transform.scale(minute_arrow, (800, 700))
second_arrow = pygame.image.load('/Users/55555/PP2/Lab_7/assets/leftarm.png')
